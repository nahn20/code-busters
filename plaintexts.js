...
var shortTexts = [
    ...
    "Three days of college... I'm glad I took that one day off in the middle and just hitchiked around the hive.",
    ...
    "Not for an old crook like me. I find I'm so excited I can barely sit still or hold a thought in my head. I think it's the excitement only a free man can feel."
];
var mediumTexts = [
    ...
    "Get busy living or get busy dying. That's goddamn right. For the second time in my life, I'm guilty of committing a crime. Parole violation. Course, I doubt they're going to throw up any road blocks for that.",
    "Many were increasingly of the opinion that they’d all made a big mistake in coming down from the trees in the first place. And some said that even the trees had been a bad move, and that no one should ever have left the oceans.",
    "You smell that? Do you smell that? Napalm, son. Nothing else in the world smells like that. I love the smell of napalm in the morning. You know, one time we had a hill bombed, for twelve hours."
];
var longTexts = [
